...
defined('CURRENCY_API_DB_DBNAME') or define("CURRENCY_API_DB_DBNAME", "binary"); // Database name
...
class CurrencyResponse{
    ...
    public function  __construct(){
        ...
        if($type=="widget") {
            ...
            $from=isset($_GET['base'])? $_GET['base'] : null;
            $to=isset($_GET['foreign'])? $_GET['foreign'] : null;
